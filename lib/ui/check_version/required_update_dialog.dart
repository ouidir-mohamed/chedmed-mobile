...
class RequiredUpdateDialog extends StatelessWidget {
  const RequiredUpdateDialog({Key? key}) : super(key: key);
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
          child: Container(
              ...
              child: Container(
                child: Text(
                    "Vous utilisez une ancienne version de cette application, cliquez sur Mettre a jour pour obtenir la derniére version"),
              ))),
      actions: <Widget>[
        MyTextButton(
          onPressed: () {
...
displayRequiredUpdateDialog(BuildContext context) {
  showDialog<String>(
      barrierDismissible: false,
      context: context,
      builder: (BuildContext context) => RequiredUpdateDialog());
}
